...
var StringSchema = (function (_super) {
    ...
    function StringSchema(template) {
        var _this = _super.call(this, template) || this;
        _this.typecheck = "(typeof ".concat(_this.id, " === \"string\")");
        _this.encoding = template.encoding || "unicode";
        _this.minLength = template.minLength || 0;
        _this.maxLength = template.maxLength || Number.MAX_SAFE_INTEGER;
        _this.validateSchema();
        return _this;
    }
    StringSchema.prototype.validateSchema = function () {
        if (this.minLength < 0) {
