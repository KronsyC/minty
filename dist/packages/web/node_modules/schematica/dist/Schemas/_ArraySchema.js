...
var ArraySchema = (function (_super) {
    ...
    Object.defineProperty(ArraySchema.prototype, "allTypes", {
        get: function () {
            var types = [];
            this.items.forEach(function (item) {
                ...
                if (item instanceof _1.ObjectSchema || item instanceof ArraySchema) {
                    types.push.apply(types, __spreadArray([], __read(item.allTypes.filter(function (t) { return !types.includes(t); })), false));
                }
            });
            return types;
        },
    ...
    Object.defineProperty(ArraySchema.prototype, "allChildren", {
        get: function () {
            var children = {};
            this.items.forEach(function (item) {
                var name = generateName(item.name);
                children[name] = item;
                if (item instanceof _1.ObjectSchema || item instanceof ArraySchema) {
